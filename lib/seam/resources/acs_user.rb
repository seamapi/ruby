...
module Seam
  module Resources
    class AcsUserAccessSchedule < BaseResource
    ...
    class AcsUserFrom < BaseResource
    ...
    class AcsUserPendingMutations < BaseResource
      ...
      resource_accessor :from, AcsUserFrom
      resource_accessor :to, AcsUserTo
    end

    class AcsUserSaltoKsMetadata < BaseResource
    ...
    class AcsUserSaltoSpaceMetadata < BaseResource
    ...
    class AcsUser < BaseResource
      resource_accessor :access_schedule, AcsUserAccessSchedule
      resource_accessor :salto_ks_metadata, AcsUserSaltoKsMetadata
      resource_accessor :salto_space_metadata, AcsUserSaltoSpaceMetadata
      resource_list_accessor :pending_mutations, AcsUserPendingMutations
