...
module Seam
  module Clients
    class AccessCodes
      ...
      def list(access_code_ids: nil, customer_ids: nil, device_id: nil, limit: nil, page_cursor: nil, user_identifier_key: nil)
        res = @client.post("/access_codes/list", {access_code_ids: access_code_ids, customer_ids: customer_ids, device_id: device_id, limit: limit, page_cursor: page_cursor, user_identifier_key: user_identifier_key}.compact)
