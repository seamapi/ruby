...
module Seam
  module Clients
    class NoiseSensors
      ...
      # @param device_type [String, nil] Device type of the noise sensors that you want to list.
      # @param device_types [Array<String>, nil] Device types of the noise sensors that you want to list.
      # @param manufacturer [String, nil] Manufacturers of the noise sensors that you want to list.
